...
const Button = (props) => {
   ...
   const fieldProps = {
      onClick: handleClick,
      disabled,
      style: { borderRadius, color, backgroundColor, width, height, borderColor, fontSize, fontWeight, opacity, minHeight:minHeight, minWidth:minWidth||"60px",padding, zIndex:zIndex,
      display: "block", justifyItems: "center", alignItems: "center",boxShadow, alignContent:"center",position:"relative"
      },
      loading:isLoading
   };
