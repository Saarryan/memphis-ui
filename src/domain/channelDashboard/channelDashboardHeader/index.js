        ...
        <div className="channel-Dashboard-header">
            ...
            <div className="details">
                <div className="main-details">
                    <p>
                        <b>Retention:</b> {state.queueDetails.retention}
                    </p>
                    <p>
                        <b>Max throughput:</b> {state.queueDetails.max_throughput}
                    </p>
                ...
                <div className="details-wrapper awaiting-messages">
                    ...
                    <div className="more-details">
                        ...
                        <Progress
                            ...
                            percent={(state.queueDetails.memory / 80) * 100}
                            size="small"
                        />
                ...
                <div className="details-wrapper awaiting-messages">
                    ...
                    <div className="more-details">
                        ...
                        <Progress
                            ...
                            percent={(state.queueDetails.cpu / 100) * 100}
                            size="small"
                        />
                ...
                <div className="details-wrapper awaiting-messages">
                    ...
                    <div className="more-details">
                        ...
                        <Progress
                            ...
                            percent={(state.queueDetails.storage / 100) * 100}
                            size="small"
                        />
